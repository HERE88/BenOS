...
run:
	/home/wang/wang/runninglinuxkernel/qemu-patch-raspberry4/build/qemu-system-aarch64 $(QEMU_FLAGS) -kernel benos.bin
debug:
	/home/wang/wang/runninglinuxkernel/qemu-patch-raspberry4/build/qemu-system-aarch64 $(QEMU_FLAGS) -kernel benos.bin -S -s
